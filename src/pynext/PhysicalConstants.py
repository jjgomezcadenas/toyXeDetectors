...
# $Id: PhysicalConstants.h,v 1.1.1.1 2004/10/12 12:23:00 jordi Exp $
# ----------------------------------------------------------------------
...
# muon_mass = 0.11*GeV  # muon mass ('Golden compliant')
muon_mass = 105.66*MeV  # muon mass
mu_mass = muon_mass     # muon mass
